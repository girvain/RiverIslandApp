...
public class AccessoriesFragment extends AbstractProductListFragment {

    @Override
    public List<Product> getProducts() {
        return new ProductFetch().fetchAndFilterByCategory("Accessories");
    }

    @Override
    public void navigationImp(View v, Product p) {
        NavDirections action = AccessoriesFragmentDirections.actionAccessoriesFragmentToSingleProductFragment(p);
