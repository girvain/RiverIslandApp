...
public class BagAndPurseFragment extends AbstractProductListFragment {

    @Override
    public List<Product> getProducts() {
        return new ProductFetch().fetchAndFilterByCategory("Bags & Purses");
    }

    @Override
    public void navigationImp(View v, Product p) {
        NavDirections action = BagAndPurseFragmentDirections.actionBagAndPurseFragmentToSingleProductFragment(p);
