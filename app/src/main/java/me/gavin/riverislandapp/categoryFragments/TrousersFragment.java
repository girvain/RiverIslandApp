...
public class TrousersFragment extends AbstractProductListFragment {

    @Override
    public List<Product> getProducts() {
        return new ProductFetch().fetchAndFilterByCategory("Trousers");
    }

    @Override
    public void navigationImp(View v, Product p) {
        NavDirections action = TrousersFragmentDirections.actionTrousersFragmentToSingleProductFragment(p);
