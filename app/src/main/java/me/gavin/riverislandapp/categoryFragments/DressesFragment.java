...
public class DressesFragment extends AbstractProductListFragment {

    @Override
    public List<Product> getProducts() {
        return new ProductFetch().fetchAndFilterByCategory("Dresses");
    }

    @Override
    public void navigationImp(View v, Product p) {
        NavDirections action = DressesFragmentDirections.actionDressesFragmentToSingleProductFragment(p);
